  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Événements {'à'.toUpperCase()} Venir</h1>
          <p className="mt-2 text-gray-600">
          Réservez des billets pour des événements et des voyages.
          </p>
        </div>
      ...
      {upcomingEvents.length > 0 ? (
        ...
        <div className="bg-gray-50 rounded-lg p-12 text-center mb-12">
          ...
          <h3 className="text-lg font-medium text-gray-900">
            Aucuns Événements {'à'.toUpperCase()} Venir.
          </h3>
          <p className="text-gray-600 mt-1">Revenez plus tard pour de nouveaux événements.</p>
        </div>
      )}
